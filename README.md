...
pontomais-mais/0.0.9 linux-x64 node-v14.7.0
$ ppp --help [COMMAND]
USAGE
  $ ppp COMMAND
...
...
_See code: [src/commands/banco.ts](https://github.com/fmilani/ppp/blob/v0.0.9/src/commands/banco.ts)_
...
_See code: [src/commands/login.ts](https://github.com/fmilani/ppp/blob/v0.0.9/src/commands/login.ts)_
<!-- commandsstop -->
